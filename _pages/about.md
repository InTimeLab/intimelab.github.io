...
+ 可视语言处理、提取与理解（含文字&图形&公式&<br>
  表格&表单&图表&流程图&思维导图&地图&线路图<br>
  &CAD图&乐谱等暨OCR、脑电、唇动、手势&手语、<br>
  动作&行为、情感&情绪等）
+ 多模态大模型与内容生成等 
+ 增量、自监督与对抗学习等
+ 图形用户界面与具身智能体<br>
...
<style>
  .news{
   ...
   right: 7%;
   width: 31%; /* 固定宽度 */
   height: 95vh; /* 固定高度，示例为视口高度的60%，可调整为具体像素值（如400px） */
...
<div class="news">
    ...
    <em><strong>25年07月11日</strong>，祝贺赵方敏文档图像恢复工作被<strong>ECAI 2025</strong>接收！</em><br>
